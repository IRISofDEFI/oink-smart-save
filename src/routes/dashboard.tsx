      ...
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="relative flex items-center gap-4 rounded-3xl border border-border bg-card/60 p-6 backdrop-blur-sm">
            ...
            <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-brand text-white glow-tile">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {actions.map((a) => (
            ...
            >
              <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-brand text-white glow-tile">
                          ...
                          <div className="flex items-start justify-between gap-3">
                            ...
                            <span
                              className={cn(
                                ...
                                unlocked ? "bg-gradient-brand-mid" : "bg-gradient-brand",
                              )}
                            >
